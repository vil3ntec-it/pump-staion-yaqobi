...
// پوشهٔ srv (سرورِ جاسازی‌شدهٔ نسخه‌های قبلی) دیگر ساخته نمی‌شود — اگر از بیلدِ
// قدیمی مانده باشد پاک می‌شود تا داخل نصب‌کننده نیاید.
fs.rmSync(path.resolve(__dirname, '..', 'srv'), { recursive: true, force: true });
