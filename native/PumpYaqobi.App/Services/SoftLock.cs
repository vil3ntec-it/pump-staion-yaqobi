...
///
/// ⚠️ <b>امروز اصلاً روشن نمی‌شود</b>، چون
/// <see cref="Entitlements.Unlocked"/> به خواستهٔ صریحِ صاحب ریپو
/// <c>true</c> است. این‌جا هیچ خطی از آن تصمیم را دور نمی‌زند: همان یک
/// مقدار که <c>false</c> شود، این هم به کار می‌افتد — و تا آن روز، هر
/// نصبی (با اشتراک، بی اشتراک، بند‌نشده) کاملاً باز است.
///
...
public static class SoftLock
{
    ...
    public static bool ReadOnly
    {
        get
        {
            //  ⛔ قفل‌ها به خواستهٔ صاحب ریپو فعلاً باز است
