...
/// <summary>
/// شناسهٔ بخش ← رنگِ آیکونش (‎IconColor.<key>‎ در <c>Icons.axaml</c>).
/// بی‌پارامتر: قلم‌موی خودِ رنگ (برای خطِ آیکون).
/// با پارامترِ <c>badge</c>: همان رنگ با آلفای کم — زمینهٔ گردِ پشتِ آیکون؛ در
/// تمِ تیره کمی پررنگ‌تر، چون روی مشکی رنگِ کم‌سو گم می‌شود.
/// </summary>
public sealed class IconColorConverter : IValueConverter
{
    ...
    public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
    {
        ...
        if (parameter as string == "badge")
        {
            ...
            return new SolidColorBrush(new Color((byte)(dark ? 56 : 38), c.R, c.G, c.B));
        }
