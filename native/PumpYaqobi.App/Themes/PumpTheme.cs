    ...
    Color[] AccentGrad) // گرادیانِ دکمه‌های اصلی
{
    ...
    ///
    /// نوارِ سرِ جدول شرابیِ **روشن‌شده** است (‎#8a6068‎). دو بار صاف‌تر شد:
    /// بارِ اول ‎#4a2a31‎ و گزارشِ صاحب ریپو «خیلی خیلی تیره است، گفتم اینو زیاد
    /// صاف‌تر کن». حالا نوار دیده می‌شود ولی سیاهیِ سنگین ندارد.
    /// </summary>
    ...
    ///
    /// روی تمِ تیره نوارِ سرِ جدول **روشن‌تر** از سطحِ جدول است (‎#2c355e‎)، نه
