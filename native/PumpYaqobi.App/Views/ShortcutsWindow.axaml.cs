...
public partial class ShortcutsWindow : Window
{
    ...
    public static readonly Row[] All = new Row[]
    {
        ...
        new("Shift + عدد",  "برداشتنِ N ردیفِ آخرِ همان جدول"),
        new("Ctrl + Delete","حذفِ همین ردیف"),
        new("Delete",       "خالی کردنِ خانه‌های انتخاب‌شده"),
        new("F2",           "باز کردنِ ویرایشِ خانه — مثلِ اکسل"),
        ...
        new("", "کپی، برش و برگشت — داخلِ جدول"),
        ...
        new("Ctrl + Z", "برگرداندنِ آخرین ویرایشِ خانه"),
