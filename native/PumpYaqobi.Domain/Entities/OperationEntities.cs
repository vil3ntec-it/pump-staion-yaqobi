...
public class Invoice : EntityBase
{
    ...
    /// <summary>
    /// نوعِ تیلی که با آن لیتر ثبت شد (‎posted_fuel_rasid.ftype‎).
    ///
    /// ⚠️ نمی‌شود موقعِ پس گرفتن از <see cref="Fuel"/>ِ همین لحظه استفاده کرد:
    /// اگر کاربر نوعِ تیلِ فاکتور را در ویرایش عوض کرده باشد، لیتر از سمتِ
    /// **اشتباه** کم می‌شود — پطرول کم می‌ماند و دیزل زیادی، بی آنکه کسی
    /// بفهمد چه شد. پس همان چیزی که ثبت شده، همان هم پس گرفته می‌شود.
    /// </summary>
    public FuelType? PostedFuelType { get; set; }
}
