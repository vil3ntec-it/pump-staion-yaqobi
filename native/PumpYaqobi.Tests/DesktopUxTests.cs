...
public class DesktopUxTests
{
    ...
    public void TheQrRowIsNeverClipped()
    {
        ...
        // جایشان را به یک نوشتهٔ کوچکِ «کیوآر» در ردیفِ پایینِ کارت دادند
        // (همان کارتی که صاحب ریپو از روی نمونه‌ها پسندید). محتوای امروز
        // حدودِ ۱۸۶ پیکسل است و ۲۰۰ی کنونی هنوز از آن بلندتر.
        Assert.True(int.Parse(m.Groups[1].Value) >= 190,
