...
public class SubSectionTests
{
    ...
    public void TheNavHasExactlyTheSitesEighteenSections()
        // ⚠️ هجده‌تای سایت + «پیام‌رسان» + «حسابِ من».
        //
        //  «حسابِ من» بیستمی است و باید بیستمی بماند: ورود با گوگل، پروفایل
        //  و اشتراک آن‌جا جمع شدند (خواستهٔ صریحِ صاحب ریپو: «چرا اشتراک تو
        //  تنظیمات است؟»). ترتیبِ هجده‌تای اول دست‌نخورده ماند —
        //  ‎NavOrderTests‎ نگهبانِ آن است.
        => Assert.Equal(20, Shell().Sections.Count);
