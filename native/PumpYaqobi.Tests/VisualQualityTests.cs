...
public class PersonColumnsTests
{
    ...
    //
    // سایت این‌طور نیست و صریح هم نوشته (خطِ ۳۴۳۲۹ی ‎index.html‎):
    ...
    public void TheColumnsAreDrivenFromCodeBehind()
    {
        ...
        // جدول اسم دارد تا جدولِ آرشیو — که آن هم ستونِ «رسید» دارد — قاطی نشود
        Assert.Contains("Name=\"PersonGrid\"", View());
    }
