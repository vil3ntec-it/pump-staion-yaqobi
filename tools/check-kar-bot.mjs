...
console.log('\n── کدِ پمپ و جداسازیِ پمپ‌ها ─────────────────────────────');
{
  ...
  //  ⛔ کدِ هشت‌رقمی (۱۴۰۵/۰۷/۱۴): رقمِ فارسی و عربی هم پذیرفته است
  ok(cloud.normalizeCode('۴۸۲۹-۱۷۳۶') === '48291736', 'رقمِ فارسی لاتین می‌شود');
  ok(cloud.normalizeCode('٤٨٢٩ ١٧٣٦') === '48291736', 'رقمِ عربی و فاصله هم');
  ok(cloud.formatCode('48291736') === '4829-1736', 'کدِ هشت‌رقمی برای نمایش خط‌تیره می‌گیرد');
